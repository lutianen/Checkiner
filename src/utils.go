...
var (
	...
	kCUTECLOUD_URL_ORIGIN  string = "https://1.cutecloud.net"
	kCUTECLOUD_URL_LOGIN   string = "https://1.cutecloud.net/auth/login"
	kCUTECLOUD_URL_CHECKIN string = "https://1.cutecloud.net/user/checkin"
